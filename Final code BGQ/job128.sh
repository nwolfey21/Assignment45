	...
	do
		...
		do
			...
			do
				...
				srun --partition medium --time 15 --ntasks $NTASKS --nodes $NODES --overcommit --runjob-opts="--mapping TEDCBA" ./assn3 -n $NODES -t $RANKS -a $THREADS -b $BLOCKED -r $RANKSPERFILE
			done
		done	
	done
done
